...
export class CreateTaskDto {
	...
	@ApiProperty({ description: 'Indicates if the task is active', default: true })
	@IsBoolean()
	is_active: boolean = true;

	@ApiProperty({ description: 'The current status of the task', enum: TaskStateList, default: TaskState.TODO })
	...
	@ApiProperty({ description: 'The optional due date of the task', type: String })
	@IsString()
	@IsOptional()
	@Type(() => String)
	due_date: String;
